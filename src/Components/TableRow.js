  ...
  return(
    <tr style={{
      ...
      <Link href={data.link} sx={{textDecoration: 'none'}}><Box component='td' className='leaderRows thin'
          sx={{textAlign: 'center', width: {xs: '85%', md:'80%'}, fontSize: {xs: '16px !important', md: '18px !important'}, lineHeight: {xs: '28px !important', md: '35px !important'}, display: 'flex', "&:hover": {color: '#FDD057', filter: 'brightness(0) saturate(100%) invert(98%) sepia(64%) saturate(6121%) hue-rotate(314deg) brightness(103%) contrast(104%);'}}}>{data?.id.slice(0, 10) + "…"}<Icon
