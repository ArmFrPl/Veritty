...
export const Leaderboards = ({ winnersRef, mobileWinnersRef, leaderboard }) => {
  ...
  const scrollToTop = () => {
    topLeadersRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "nearest",
      inline: "start",
    });
  ...
  const mobileScrollToTop = () => {
    mobileTopLeadersRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "nearest",
      inline: "start",
    });
  ...
  const mobileScrollToBottom = () => {
    mobileLeadersRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "nearest",
      inline: "start",
    });
  ...
  return (
    <>
      <Box
        className="leadersCont"
        ref={mobileWinnersRef}
        sx={{
      ...
      >
        ...
        <Box
          sx={{
            ...
            lineHeight: "28px",
            background:
              "linear-gradient(0deg, #FFFFFF, #FFFFFF), linear-gradient(180deg, #FF9700 0%, #FFD057 66.15%), #FFD057;",
            backgroundClip: "text",
            textFillColor: "transparent",
            mt: "20px",
          }}
        >
          Top-100 lottery leaders
        </Box>
        <InputBase
          id="outlined-search"
          type="search"
          ...
          <table className="leaders" style={{ width: "100%" }}>
            <tbody>
              ...
              >
                ...
                >
                  <img alt="arrow" src={GoDown} height={30} width={30} />
                </Icon>
              </Box>
              <div
              ...
              >
                ...
                {filteredLeaders?.map((l, index) => {
                  if (index + 1 === 1) {
                    ...
                    return <TableRow data={l} index={index} />;
                  }
                })}
