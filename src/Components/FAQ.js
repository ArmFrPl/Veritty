...
export const FAQ = ({ faqRef, mobileFaqRef }) => {
  const names = [
    ...
    },
    {
      ...
      value:
        "You can view all the tickets that you have purchased for live and ended raffles by going to the History section on the Dashboard. Click on the tx hash of tickets to see a complete transaction on the blockchain on EtherScan",
    },
  ];
  return (
    <>
