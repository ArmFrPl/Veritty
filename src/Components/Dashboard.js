      ...
      <Box className='dashboardCont' sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            color: '#F8F8F8',
            textAlign: 'left',
          }}>Total tickets: <Box component='span' sx={{color: '#FFAC33', fontSize: '14px', ml: '10px'}}>3</Box> </Box>
          <Box sx={{
            fontFamily: 'Epilogue',
            fontStyle: "normal",
            fontWeight: 700,
            ...
            textAlign: 'left',
            mt: '13px',
          }}>Total winnings USDT: <Box component='span' sx={{color: '#FFAC33', fontSize: '14px', ml: '10px'}}>5.000
            USDT</Box> </Box>
        </Box>
        <Box sx={{
          width: '90%',
                ...
                history?.map((h, index) => (
                  <tr style={{
                    ...
                    <Box component='td' className='historyRows'
                        sx={{textAlign: 'left', width: '4%', marginRight: '15px', fontSize: {xs: '14px', md: '18px'}, lineHeight: {xs: '28px', md: '35px'}}}>{index + 1}</Box>
                    <Box component='td' className='historyRows bold'
                        sx={{textAlign: 'left', width: '40%', fontSize: {xs: '16px', md: '20px'}, lineHeight: {xs: '22px', md: '28px'}}}>{h.winning}</Box>
                    <Box component={'td'} className='historyRows'
                        sx={{textAlign: 'left', width: '65%', marginLeft: '30px', fontSize: {xs: '14px', md: '18px'}, lineHeight: {xs: '28px', md: '35px'}}}>{h.date}<Icon sx={{
                      color: '#FFFFFF'
                    }}><img alt='arrow'
