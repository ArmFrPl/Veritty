...
export const Dashboard = ({
  ...
  const scrollToTop = () => {
    topDataRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "nearest",
      inline: "start",
    });
  ...
  const mobileScrollToTop = () => {
    mobileTopDataRef.current?.scrollIntoView({
      block: "nearest",
      inline: "start",
    });
  };
  ...
  const mobileScrollToBottom = () => {
    mobileDataRef.current?.scrollIntoView({
      block: "nearest",
      inline: "start",
    });
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          Here you can find the information about our your tickets!{" "}
        </Box>
        <Box
          sx={{
            width: "90%",
